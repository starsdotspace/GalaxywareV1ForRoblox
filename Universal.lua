...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/asfsnfskjsfjdgkjgfhfjhfjhfsjhjfjfh/GalaxywareV1ForRoblox/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
		assert(suc, res)
...
do
	...
	task.spawn(function()
		...
		whitelistloaded = pcall(function()
			local commit = "main"
			for i,v in pairs(game:HttpGet("https://github.com/asfsnfskjsfjdgkjgfhfjhfjhfsjhjfjfh/whitelists"):split("\n")) do 
			...
			WhitelistFunctions.WhitelistTable = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/asfsnfskjsfjdgkjgfhfjhfjhfsjhjfjfh/whitelists/"..commit.."/PlayerWhitelist.json", true))
		end)
